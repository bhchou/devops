...
// using Oracle-Linux-8.5-aarch64-2022.04.26-0"
  node_source_details {
    image_id    = "ocid1.image.oc1.me-jeddah-1.aaaaaaaayppsyuujsgdusrcmrop7pblxfxyeyka57btomkgqhgxbbfd7slla"
    source_type = "image"
  }

  initial_node_labels {
    key   = "name"
    value = "ksa-k8s-cluster"
  }
